...
namespace SchoolApp.Controllers
{
    ...
    public class SchoolClassesController : Controller
    {
        ...
        public SchoolClassesController(SchoolAppDbContext context, UserManager<AppUser> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                // Checks all the users and gets the user who has the same id with TeacherId.
                schoolClass.Teacher = await _userManager.Users.FirstOrDefaultAsync(appuser => appuser.Id == schoolClass.TeacherId);
            }
